...
public class ConfiguracionSeguridad extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .and()
                .formLogin()
                .loginPage("/perfiles/formulario-iniciar-sesion-o-insertar")
                ...
                .failureUrl("/perfiles/formulario-iniciar-sesion-o-insertar?error=true")//no es necesario que sea true se peude poner cualquier cosa,es una query string, dato en la ruta
                .permitAll()
                .and()
                .logout()
